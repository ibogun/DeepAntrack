 ...
 * @param verbose_
 */
void armadillo::OLaRank_old::setParameters(armadillo::params& learningParams, int& balance, int& m_,int& verbose_) {
 ...
 */
tuple<mat, mat, mat> armadillo::OLaRank_old::processNew(mat& newX, mat& y_hat,const int label,int frameNumber) {
...
double armadillo::OLaRank_old::kernel_fast(mat& x,mat& y_loc, int y,int frameNumber_1, mat& xp,mat& yp_loc, int yp,int frameNumber_2){
...
double armadillo::OLaRank_old::calculate_kernel(mat& x, int y, mat& xp, int yp){
 ...
 */
armadillo::OLaRank_old::OLaRank_old(Kernel* svm_kernel_,params& learningParams, int& balance, int& m_,
                         int& verbose_) {
 ...
 */
int armadillo::OLaRank_old::processAndPredict(mat& newX, mat& newY,int frameNumber) {
 ...
 * @param y_hat					- label
 */
void armadillo::OLaRank_old::process(mat& newX, mat& y_hat, int y_hat_label,int frameNumber) {
 ...
 *  @param y 			first label
 */
void armadillo::OLaRank_old::initialize(mat& x, mat& y,const int label,int frameNumber) {
